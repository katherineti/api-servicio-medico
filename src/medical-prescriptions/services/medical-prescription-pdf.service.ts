...
export class RecipePdfService {
  ...
  async generateRecipePdf(data: MedicalPrescription): Promise<Buffer> {
  ...
  private generateHtmlTemplate(data: MedicalPrescription): string {
  let patientBirthYear:string = '';
  ...
  //Capitaliza solo la primera letra de la primera palabra y el resto en minúsculas
