...
console.log('endOfDay:', endOfDay);
      ...
      const completeStats: CompleteAssignmentStats = {
        ...
        totalProductsAssignedThisMonthOrToday: options.reportType === "day"? Number( (await this.assignmentService.countProductsAssignmentOfTheDay()).count ) : Number( (await this.assignmentService.countProductsAssignmentOfMonth()).count ),
        assignmentsByEmployee,
        assignmentsByProductType,
        assignmentsByFamily,
        registrationsByDay,
