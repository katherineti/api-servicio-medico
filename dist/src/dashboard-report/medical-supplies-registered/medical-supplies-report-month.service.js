...
var MedicalSuppliesReportMonthService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.MedicalSuppliesReportMonthService = void 0;
...
let MedicalSuppliesReportMonthService = MedicalSuppliesReportMonthService_1 = class MedicalSuppliesReportMonthService {
    constructor(db, dashboardReportService) {
        this.db = db;
        this.dashboardReportService = dashboardReportService;
        this.logger = new common_1.Logger(MedicalSuppliesReportMonthService_1.name);
    }
    ...
    async getCompleteMedicalSupplyStats() {
        try {
            ...
            const [generalStats] = await this.db
                ...
                productsToday: (0, drizzle_orm_1.sql) `count(CASE WHEN ${schema_1.productsTable.createdAt} >= ${startOfMonth} AND ${schema_1.productsTable.createdAt} <= ${endOfMonth} THEN 1 ELSE NULL END)`,
            })
            ...
            const productsByCategoryResult = await this.db
                ...
                .innerJoin(schema_1.productsTable, (0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.productsTable.categoryId, schema_1.categoriesTable.id), (0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.productsTable.createdAt, startOfMonth), (0, drizzle_orm_1.lte)(schema_1.productsTable.createdAt, endOfMonth)), (0, drizzle_orm_1.inArray)(schema_1.productsTable.statusId, [1, 2, 3, 4])))
                .where((0, drizzle_orm_1.inArray)(schema_1.productsTable.statusId, [1, 2, 3, 4]))
            ...
            const registrationsByDayResult = await this.db
                ...
                .from(schema_1.productsTable)
                .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.productsTable.createdAt, startOfMonth), (0, drizzle_orm_1.lte)(schema_1.productsTable.createdAt, endOfMonth), (0, drizzle_orm_1.inArray)(schema_1.productsTable.statusId, [1, 2, 3, 4])))
    ...
    async createCustomMedicalSuppliesDocumentDefinition(reportData, medicalSupplyStats) {
        try {
            ...
            const content = [];
            let reportTitle = "REPORTE ESTADÍSTICO DEL INVENTARIO ALMACÉN REGISTRADO EN EL MES";
            content.push({
                text: reportTitle,
                style: "reportTitle",
            });
    ...
    addTodayProductsSection(content, medicalSupplyStats, styles) {
        if (medicalSupplyStats.todayProducts && medicalSupplyStats.todayProducts.length > 0) {
            ...
            content.push({ text: "Inventario Almacén Registro en el Mes", style: "sectionTitle" }, {
...
exports.MedicalSuppliesReportMonthService = MedicalSuppliesReportMonthService;
exports.MedicalSuppliesReportMonthService = MedicalSuppliesReportMonthService = MedicalSuppliesReportMonthService_1 = __decorate([
...
//# sourceMappingURL=medical-supplies-report-month.service.js.map